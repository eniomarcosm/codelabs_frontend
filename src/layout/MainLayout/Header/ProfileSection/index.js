                                ...
                                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    <Box sx={{ p: 2 }}>
                                        <Stack>
                                            ...
                                            <Typography variant="subtitle2">{currentUser.tipo ===1 ? "Administrador" : "Técnico"}</Typography>
                                        </Stack>
                                        {/* <OutlinedInput
                                        ...
                                        />
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <ListItemText primary={<Typography variant="body2">Definições de Conta</Typography>} />
                                                </ListItemButton>
                                                <ListItemButton
                                                    sx={{ borderRadius: `${customization.borderRadius}px` }}
